  ...
  #git fetch http://review.cyanogenmod.org/CyanogenMod/android_device_sony_common refs/changes/45/158145/1 && git cherry-pick FETCH_HEAD
  ...
  git fetch http://review.cyanogenmod.org/CyanogenMod/android_device_qcom_sepolicy refs/changes/79/158279/1 && git cherry-pick FETCH_HEAD
  git reset --hard HEAD; git stash -u;
  ...
  git fetch http://review.cyanogenmod.org/CyanogenMod/android_external_libselinux refs/changes/28/158228/1 && git cherry-pick FETCH_HEAD
  git reset --hard HEAD; git stash -u;
  ...
  #cd external/stlport/;
  #git reset --hard HEAD; git stash -u;
  #git fetch http://review.cyanogenmod.org/CyanogenMod/android_external_stlport refs/changes/15/158215/1 && git cherry-pick FETCH_HEAD
  ...
  cd external/toybox/;
  git reset --hard HEAD; git stash -u;
  git fetch http://review.cyanogenmod.org/CyanogenMod/android_external_toybox refs/changes/18/158218/1 && git cherry-pick FETCH_HEAD
  git fetch http://review.cyanogenmod.org/CyanogenMod/android_external_toybox refs/changes/16/158116/1 && git cherry-pick FETCH_HEAD
  git fetch http://review.cyanogenmod.org/CyanogenMod/android_external_toybox refs/changes/92/158192/2 && git cherry-pick FETCH_HEAD
  ...
  git reset --hard FETCH_HEAD; git stash -u
  # ==========================================================Taoshan has audio disabled for now
  # hardware/qcom/audio
  #croot;
  ...
  git fetch http://review.cyanogenmod.org/CyanogenMod/android_hardware_qcom_media refs/changes/74/158174/3 && git cherry-pick FETCH_HEAD
  git reset --hard HEAD; git stash -u;
  # ==========================================================
  ...
  croot;
  cd hardware/ril/;
  git fetch http://review.cyanogenmod.org/CyanogenMod/android_hardware_ril refs/changes/31/76431/1 && git cherry-pick FETCH_HEAD
  git reset --hard HEAD; git stash -u;
  ...
  cd system/sepolicy/;
  git reset --hard HEAD; git stash -u;
  git fetch http://review.cyanogenmod.org/CyanogenMod/android_system_sepolicy refs/changes/87/158287/1 && git cherry-pick FETCH_HEAD
